...
object ModelPredict {
  ...
  def main(args: Array[String]): Unit = {
    ...
    def runModelPredict(Symbol: String): Unit = {
      ...
      // clean train data
      val cleanTestData = machineLearning.DataCleaner.cleanData(dataFrame = rawTestData)
      ...
      // save prediction
      machineLearning.OutputSaver.predictionsSaver(sparkSession = spark, dataFrame = predictions, Symbol = stock_symbol)
    }
